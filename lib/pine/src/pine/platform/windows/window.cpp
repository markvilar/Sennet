...
void WindowsWindow::init()
{
    ...
    glfwSetWindowSizeCallback(window,
        ...
        {
            WindowData& data
                = *static_cast<WindowData*>(glfwGetWindowUserPointer(reference_window));
    ...
    glfwSetWindowCloseCallback(window,
        ...
        {
            WindowData& data = *static_cast<WindowData*>(glfwGetWindowUserPointer(reference_window));
...
const std::string& WindowsWindow::get_title() const { return window_data.title; }
