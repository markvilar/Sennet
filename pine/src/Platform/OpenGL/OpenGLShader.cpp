...
void OpenGLShader::SetIntArray(
    const std::string& name, const int* values, const uint32_t count)
{
...
void OpenGLShader::UploadUniformFloat2(
    const std::string& name, const Vec2& values)
{
    GLint location = glGetUniformLocation(m_RendererID, name.c_str());
...
void OpenGLShader::UploadUniformFloat3(
    const std::string& name, const Vec3& values)
{
    GLint location = glGetUniformLocation(m_RendererID, name.c_str());
...
void OpenGLShader::UploadUniformFloat4(
    const std::string& name, const Vec4& values)
{
    GLint location = glGetUniformLocation(m_RendererID, name.c_str());
...
void OpenGLShader::UploadUniformMat3(
    const std::string& name, const Mat3& matrix)
{
    GLint location = glGetUniformLocation(m_RendererID, name.c_str());
...
void OpenGLShader::UploadUniformMat4(
    const std::string& name, const Mat4& matrix)
{
    GLint location = glGetUniformLocation(m_RendererID, name.c_str());
